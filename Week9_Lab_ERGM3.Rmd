...
- It is more likely that people of the same age are friends
- More popular scholars prefer to collaborate with other popular scholars
- Companies want to trade with other companies in the same sector

---
# Thinking in Varibles:
...
## Even if your hypotheses do not point you to structural terms, they still must be in the model (2 H at least).
...
# Handling large networks
<br>
## If your project requires large networks (even around 500)
...
It is better to have a simple project than super fancy attempts that nobody can understand. 
<br>
