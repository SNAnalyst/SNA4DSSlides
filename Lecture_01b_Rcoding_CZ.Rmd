...
# Does your Rstudio look like this?
...
## if it doesn't look like this, run the `snaverse::rstudiofy()` function?

<br>
## If you have problems, errors or warning - move on with a manual set up
...
## `remotes::install_github("czucca/GERGM", dependencies = TRUE, force = TRUE)`
<br>
...
<br>
<br>
## .red[Do not ask for help, unless you went through all the documentation by yourself and you failed]
...
You can also use it to practice for the exams
...
## - Do not run code in the Rstudio console if you are running a tutorial

## - If you right click on the R icon you can open more than one R window at the same time, 

## - Run tutorials and code in different windows

## - Your code should be replicable, hence use the click and point options in R as little as humanly possible
...
## DO NOT DO THAT! .red[You will be downgraded both in the exams and in the project.]
