...
(tutorials, lab, Easly & Kleinberg chapters)
...
# Betweenness as driver of success

Imagine an artist with ties to

* both Nashville and the pop scene
* music industry and Hollywood
* older generation and younger generation collaborators
* a variety of cultural and social groups

These are groups that are relatively weakly connected to each other.

`r arrow_right()` This opens up a giant audience other artists can only dream of
...
background-image: url(assets/images/dolly3.png)
