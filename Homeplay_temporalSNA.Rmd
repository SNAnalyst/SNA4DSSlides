...
After you run the model:<br>
* step 1: interpret the findings of the model--which effect are (not) statistically significant and does that make sense?<br>
* Step 2: What do you think of the model's goodness of fit?
...
As an example, suppose that your model.03 looked as follows:
...
Plot the gof:<br>
`snafun::stat_plot_gof(gof.03)`


===============================<br>
By the way, you can also simulate a set of networks without automatically 
