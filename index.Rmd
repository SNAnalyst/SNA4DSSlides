...
Find the [SNA4DS cheatsheet here](https://snanalyst.github.io/cheatsheet.html).

------------------------------------------------------------------------



<!-- Week 03 -- Lecture: Intro to SNA4DS -->   
...
overview <- matrix(c(                                         
 ...
 "examples-of-relationships", "Examples of edges",
 "examples-of-networks-internet", "Examples: internet",      
 "examples-of-networks-HPlab", "Examples: HP Lab",           
 "examples-of-networks-blogosphere", "Examples: Blogosphere",
 "SNA4DS_topics", "SNA4DS topics"                            
), byrow = TRUE, ncol = 2) |>                                 
as.data.frame() |>                                            
 setNames(c("name", "description"))                          
                                                             
slidedeckFile <- "Lecture_01a_publish"                        
lectureName <- "Week 03 -- Lecture: Intro to SNA4DS, I"          
```                                                           
                                                            
`r make_overview(overview, path, slidedeckFile, lectureName)`


<!-- Week 03 – Lecture: Intro to SNA4DS, II -->      

```{r, include = FALSE}                                      
overview <- matrix(c(                                        
 "intro_nets", "Two starts for one happy story",            
 "graph_theory", "Graph theory"                             
), byrow = TRUE, ncol = 2) |>                                
as.data.frame() |>                                           
 setNames(c("name", "description"))                         
                                                            
slidedeckFile <- "Lecture_01b_CZ"                            
lectureName <- "Week 03 – Lecture: Intro to SNA4DS, II"      
```                                                          
...
slidedeckFile <- "Lab_01_CZ"                                 
lectureName <- "Week 03 - Lab: Intro to R"                   
```                                                          
...
lectureName <- "Week 04 - Lab: Intro to SNA in R"                   
```                                                          
...
<!-- Week 04 - Lecture: Social Network Measures -->         
```{r, include = FALSE}                                      
overview <- matrix(c(                                        
 "gamenet", "The network of the game",                      
...
slidedeckFile <- "Week04_Lecture_Measures"                   
lectureName <- "Week 04 - Lecture: Social Network Measures" 
```                                                          
...
slidedeckFile <- "Lab-04_Measures"                           
lectureName <- "Week 05 - Lab: Network measures"             
```                                                          
                                                            
`r make_overview(overview, path, slidedeckFile, lectureName)`


<!-- Week 05 - Lecture: Network models -->                                
```{r, include = FALSE}                                                   
overview <- matrix(c(                                                     
 "menu", "Menu",                                                         
...
slidedeckFile <- "Lecture_week05_stats"                                   
lectureName <- "Week 05 - Lecture: Network models"                        
```                                                                       
...
# slidedeckFile <- "C:\\Dropbox\\R\\eigen_packages\\=git\\SNA4DSSlides\\SNA4DSSlides\\Lab__week06__stats-publish"
slidedeckFile <- "Lab__week06__stats"
lectureName <- "Week 06 - Lab: Network models"                                                                 
```                                                                                                            
...
<!-- Week 07 -- Lecture: Network data collection -->                         
```{r, include = FALSE}                                                      
overview <- matrix(c(                                                        
...
slidedeckFile <- "Week07_Lecture_CZ_collecting_data"                         
lectureName <- "Week 07 -- Lecture: Network data collection"                 
```                                                                          
...
<!-- Week 08 -- Lab: Network visualization -->                                                     
```{r, include = FALSE}                                                                            
overview <- matrix(c(                                                                              
...
slidedeckFile <- "Week08-Lab-Visualizations"                                                       
lectureName <- "Week 08 -- Lab: Network visualization"                                             
```                                                                                                
...
slidedeckFile <- "Week09_Lecture_ERGM1"                                                                               
lectureName <- "Week 09 -- Lecture: ERGM I"                                                                           
```                                                                                                                   
...
slidedeckFile <- "Week09_Lecture_ERGM2"                             
lectureName <- "Week 09 -- Lecture: ERGM II"                        
```                                                                 
...
slidedeckFile <- "Week10_Lab_ERGM1"                                           
lectureName <- "Week 10 -- Lab: ERGM I"                                       
```                                                                           
...
slidedeckFile <- "Week10_Lecture_ERGM3"                                     
lectureName <- "Week 10 -- Lecture: ERGM III"                               
```                                                                         
...
slidedeckFile <- "Week11_Lab_ERGM2"                          
lectureName <- "Week 11 -- Lab: ERGM II"                     
```                                                          
...
slidedeckFile <- "Week11_Lecture_ERGM4"                                          
lectureName <- "Week 11 -- Lecture: ERGM IV"                                     
```                                                                              
...
slidedeckFile <- "Week12_Lab_ERGM3"                                
lectureName <- "Week 12 -- Lab: ERGM III"                          
```                                                                
