...
slidedeckFile <- "Week05_Lab_ERGM1-without_homeplay"         
lectureName <- "Week 05 -- Lab: ERGM I"                      
```                                                          
...
<!-- Week 06 - Lecture: Data Collection -->                                
```{r, include = FALSE}                                                    
overview <- matrix(c(                                                      
...
slidedeckFile <- "Week06_Lecture_CZ_collecting_data"                       
lectureName <- "Week 06 - Lecture: Data Collection"                        
```                                                                        
                                                                        
`r make_overview(overview, path, slidedeckFile, lectureName)` 


<!-- Week 07 - Lecture: ERGM III -->                                      
```{r, include = FALSE}                                                   
overview <- matrix(c(                                                     
...
slidedeckFile <- "Week07_Lecture_ERGM3"                                   
lectureName <- "Week 07 - Lecture: ERGM III"                              
```                                                                       
...
slidedeckFile <- "Week08_Lab_ERGM2"                          
lectureName <- "Week 08 - Lab: ERGM II"                      
```                                                          
...
slidedeckFile <- "Week08_Lecture_ERGM4"                                        
lectureName <- "Week 08 - Lecture: ERGM IV"                                    
```                                                                            
...
slidedeckFile <- "Week9_Lab_ERGM3"                               
lectureName <- "Week 09 - Lab: ERGM III"                         
```                                                              
...
<!-- Week 09 - Lecture: Temporal Networks -->                           
```{r, include = FALSE}                                                 
overview <- matrix(c(                                                   
...
lectureName <- "Week 09 - Lecture: Temporal Networks"                   
```                                                                     
...
lectureName <- "Week 11 -- Lab: Temporal networks"           
```                                                          
                                                          
`r make_overview(overview, path, slidedeckFile, lectureName)`


<!-- Week 11 -- Lecture: Graph Machine Learning -->                    
```{r, include = FALSE}                                                
overview <- matrix(c(                                                  
"Menu", "Topics covered in today's lecture",                           
"stats_to_ml", "Transition from statistical models to machine learning"
), byrow = TRUE, ncol = 2) |>                                          
as.data.frame() |>                                                     
setNames(c("name", "description"))                                     
                                                                    
slidedeckFile <- "Week11-Lecture-GraphML"                              
lectureName <- "Week 11 -- Lecture: Graph Machine Learning"            
```                                                                    
                                                                    
`r make_overview(overview, path, slidedeckFile, lectureName)`   


<!-- Week 14 -- Lab: Exam Prep -->                           
```{r, include = FALSE}                                      
overview <- matrix(c(                                        
"frontpage", "exam frontpage",                               
"best_model", "best model",                                  
"application", "application to a field",                     
"walktrap", "application to a field",                        
"friendships", "fewer friends than my friends",              
"stress", "stress centrality",                               
"pagerank", "pagerank centrality",                           
"conference", "temporal data"                                
), byrow = TRUE, ncol = 2) |>                                
as.data.frame() |>                                           
setNames(c("name", "description"))                           
                                                        
slidedeckFile <- "Lab_Exam"                                  
lectureName <- "Week 14 -- Lab: Exam Prep"                   
```                                                          
