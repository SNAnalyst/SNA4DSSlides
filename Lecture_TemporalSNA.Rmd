...
<br><br><br>
`r arrow_right()` You can now use all of the tools you learned in this course _on each slice_ separately.
...
You discard the exact timing of the interactions, but you focus on what happens first, 
what happens next, et cetera. 
...
`r arrow_right()` The statistical models for this are surprisingly straightforward
...
- methods are still very much in development .font60[(JADS & TiU are world-leading in this field)]
...
In this network, it is useful to add vertex **geographic location** and <br>
**edge type** (e.g., *which foot*, *success*, *speed*, *under pressure*, etc.).
<br>
...
<br>
Note: in this example, there are also self-edges/loops and <br>
"non-player" edges (e.g., goal, line, woodwork)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r arrow_right()` Statistical models: beyond this course

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r arrow_right()` Deep learning models: lecture in two weeks
...
You experienced the speed of the ERGM....it is slooooooooooow....because 
it uses MCMC-LE.
...
df[2,] <- c("Time-varying dyadic covariates", "A list of networks or matrices")
df[1,] <- c("Constant dyadic covariates", "Single network or matrix")
...
<br><br><br>
`r arrow_right()` Similar to what you are used to with ERGM's
]
