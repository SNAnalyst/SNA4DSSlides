...
The study: <br>where did people who moved jobs in the Boston area get the information about the job?

<br><br>
The finding: <br>Casual acquaintances are often more valuable than close friends for finding new jobs and novel information.

<br><br>

`r arrow_right()` .b.i[The strength of weak ties]

]

.pull-right[
.animated.fadeIn[![:scale 200%](assets/images/MarkGranovetter2a.png)]
]


---

# Is this still valid 50 years later?

![](assets/images/science-sowt.png# absolute ofc w-6-12th h-3-12th t-9-12th l-6-12th)

In 2022, researchers from MIT, Harvard, Stanford, and LinkedIn published a formal test of the theory with large data in the journal .i[Science].

.u[Experiment]: LinkedIn's "People You May Know" (PYMK) recommendation engine

.u[Sample]: 20 million users over a five-year period--2 billion new connections and 600000 job changes.

.u[Setup]:  Some users were recommended strong ties (= people they shared many mutual friends with), while others were recommended weak ties (acquaintances with very few mutual contacts). The researchers then waited to see if these newly formed connections actually resulted in the user applying for—and securing—a job at the contact's company.<br>

--

`r arrow_right()` Weak ties still promote finding a new job in Digital & High-Tech Industries. In non-digital sectors, strong ties were more effective.
...
# Why the exploding interest in social networks?


--
* empirical findings piling up about SNA usefulness
* there is so much data (especially digital traces--email, sensors, forums, databases, etc.)
* improved analysis techniques/models/algorithms
* many practical applications (e.g., business strategy, military interventions, forecasting)
...
`r chevron_right()` Labs are online (Zoom)
 
`r chevron_right()` Lectures are in the attic
...
- do the tutorial through `sna4tutti`

- do the *homeplay* (usually posted on Canvas)
